...
def process_conversational_chain_docs():
    ...
    Use the following pieces of retrieved context and rules only to formulate an answer for the list of questions given. \
    If you cannot formulate an answer from the given retrieved context and rules, tell the user to ask inside the GUC scope. \
...
def initialize_session_state():
    ...
    if "messages" not in st.session_state:
        ...
        st.session_state.model = ChatGoogleGenerativeAI(model="gemini-1.5-pro", temperature=0.5, safety_settings=safety_settings)
